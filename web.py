...
face_cascade = cv2.CascadeClassifier('C:/Users/adith/AppData/Local/Programs/Python/Python310/Lib/site-packages/cv2/data/haarcascade_frontalface_default.xml')
...
def main():
    ...
    st.title("My Face Recognition Project!!!")
